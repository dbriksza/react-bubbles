...
Authentication- i.e. you are who you say you are because no one else has this big custom string

- [ ] What steps can you take in your web apps to keep your data secure?

Adding authentication in the form of tokens

- [ ] Describe how web servers work.

Web servers use HTTP to recieve and send data from and to users
